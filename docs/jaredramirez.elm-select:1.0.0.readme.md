...
> This is a fork of https://github.com/Confidenceman02/elm-select due to a dependency problem. Once [the issue](https://github.com/Confidenceman02/elm-select/issues/26) is fixed, you should use that package instead.
